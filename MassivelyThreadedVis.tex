...
\permission{ (c) 2013 Association for Computing Machinery. ACM acknowledges
  that this contribution was authored or co-authored by an employee,
  contractor or affiliate of the United States government. As such, the
  United States Government retains a nonexclusive, royalty-free right to
  publish or reproduce this article, or to allow others to do so, for
  Government purposes only.
}
\conferenceinfo{Ultravis'13}{November 17, 2013, Denver, CO, USA}
\CopyrightYear{2013}
\crdata{978-1-4503-2500-4/13/11}
\acmdoi{10.1145/2535571.2535591}
...
\newcommand{\exampleimage}[2][.31]{\includegraphics[width=#1\textwidth]{images/Example#2}}
...
\begin{figure*}
  \centering
  \exampleimage[.4]{Elevation}
  \exampleimage[.4]{GenerateIds} \\
  \exampleimage[.4]{SurfaceVectors}
  \exampleimage[.4]{Warp}
...
\begin{figure*}[p]
  \centering
  \exampleimage{CellCenters}
  \exampleimage{CellDerivatives}
  \exampleimage{MeshQuality}
...
\begin{figure*}[p]
  \centering
  \exampleimage[.4]{Extract}
  \exampleimage[.4]{Threshold}
...
\begin{figure*}[p]
  \centering
  \exampleimage[.4]{Glyph}
  \exampleimage[.4]{Ribbon}\\
  \exampleimage[.4]{Shrink}
  \exampleimage[.4]{Tube}
...
\begin{figure*}
  \centering
  \exampleimage[.4]{Clip}
  \exampleimage[.4]{Contour} \\
  \exampleimage[.4]{Slice}
  \exampleimage[.4]{Tessellate}
...
\begin{figure*}
  \centering
  \exampleimage[.4]{ExtractEdges}
  \exampleimage[.4]{FeatureEdges} \\
  \exampleimage[.4]{Gradient}
  \exampleimage[.4]{Normals}
